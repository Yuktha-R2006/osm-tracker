...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0f172a] relative overflow-hidden px-4">
      ...
      <div className="absolute bottom-[-20%] left-[-10%] w-96 h-96 bg-secondary/20 rounded-full blur-[100px] pointer-events-none"></div>
      
      <div className="w-full max-w-md p-8 glass-panel z-10">
        <div className="text-center mb-8">
          <MonitorPlay size={48} className="mx-auto text-primary mb-4" />
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-slate-800/50 border border-slate-700 rounded-lg py-3 pl-10 pr-4 text-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all"
          ...
          <button 
            type="submit"
            className="w-full py-3 bg-linear-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-white rounded-lg font-medium transition-all shadow-lg shadow-primary/25"
          >
            Sign Up
          </button>
        </form>
